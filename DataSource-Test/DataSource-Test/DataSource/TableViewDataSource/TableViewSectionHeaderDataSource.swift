//
//  TableViewSectionHeaderDataSource.swift
//  DataSource-Swift
//
...
class TableViewSectionHeaderDataSource<RowModelClass,SectionModelClass>: NSObject,UITableViewDataSource,UITableViewDelegate {
